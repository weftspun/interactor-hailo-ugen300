...
m = onnx.load("/work/qwen3vl_vit.onnx")
...
onnx.save(ms, "/work/qwen3vl_vit_sim.onnx", save_as_external_data=False)
print("wrote qwen3vl_vit_sim.onnx")
...
t = time.time()
try:
    r.translate_onnx_model("/work/qwen3vl_vit_sim.onnx", "qwen3vl_vit",
